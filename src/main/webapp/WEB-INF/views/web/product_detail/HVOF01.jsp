								...
								<div class="col-md-8 offset-md-2 text-center">
									...
									<div class="prd-img-detail">
										<div class="xzoom-container">
									        <img class="xzoom" src="<c:url value="/assets/user/img/portfolio/HVOF01_1.png" />" xoriginal="<c:url value="/assets/user/img/portfolio/HVOF01_1.png" />" />
									        <div class="xzoom-thumbs">
									            <a href="<c:url value="/assets/user/img/portfolio/HVOF01_1.png" />">
									                <img class="xzoom-gallery" width="50" src="<c:url value="/assets/user/img/portfolio/HVOF01_1.png" />" xpreview="<c:url value="/assets/user/img/portfolio/HVOF01_1.png" />">
									            </a>
										...
										<table style="width: 100%">
		                                    <tbody>
		                                       ...
		                                       <tr>
		                                            ...
		                                            <td class="column2">Có (Loa, mic tích hợp 2 chiều trong camera)</td>
		                                        </tr>
		                                       <tr>
