					...
					<div class="about-right">
						<div>
							...
							<div class="text-center" >
								<figure class="image"><img alt="" src="<c:url value="/assets/user/img/cong_ty.jpg"/>" >
									<figcaption>Công ty Trách Nhiệm Hữu Hạn Thiết Bị Viễn Thông ANSV | Advanced Network System VietNam<br>
									124 Hoàng Quốc Việt, Cầu Giấy, Hà Nội
									</figcaption>
								</figure>							
							</div>
							<h3 class="title"><strong>Giới thiệu</strong></h3>
						...
						<div  class="mt-5">
							...
							<p>
								...
								<span> "Con người là sức mạnh"- Với nguồn lực là đội ngũ cán bộ, kỹ sư được đào tạo bài bản và có nhiều năm kinh nghiệm, ANSV là nơi quy tụ và kết nối những nhân tài có sức sáng tạo và đam mê, cùng hướng tới mục tiêu phát triển các sản phẩm, giải đáp, 
